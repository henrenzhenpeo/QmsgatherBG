...
/**
* @author dafenqi
* @description 针对表【df_up_bg_liquid_throwing(bg 液抛)】的数据库操作Service实现
* @createDate 2024-12-12 15:16:23
*/
@Service
@Transactional
public class DfUpBgLiquidThrowingServiceImpl extends ServiceImpl<DfUpBgLiquidThrowingMapper, DfUpBgLiquidThrowing>
    implements DfUpBgLiquidThrowingService{
    @Autowired
    private DfUpBgLiquidThrowingMapper dfUpBgLiquidThrowingMapper;
    ...
    public String getMaxBatchId() {
        String maxBatchId = dfUpBgLiquidThrowingMapper.getMaxBatchId();
        // 生成新的批次号
