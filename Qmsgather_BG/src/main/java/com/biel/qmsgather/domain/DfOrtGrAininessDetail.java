...
/**
 * 颗粒度度测量详情
 * @TableName df_ort_gr_aininess_detail
 */
@TableName(value ="df_ort_gr_aininess_detail")
@Data
public class DfOrtGrAininessDetail {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        DfOrtGrAininessDetail other = (DfOrtGrAininessDetail) that;
