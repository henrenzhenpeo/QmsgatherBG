...
//
// import com.biel.qmsgather.domain.DfYfExcelYf115C98bBlueSandblastingGridTestS2Data;
// import com.biel.qmsgather.mapper.DfYfExcelYf115C98bBlueSandblastingGridTestS2DataMapper;
...
//
//     @Autowired
//     private DfYfExcelYf115C98bBlueSandblastingGridTestS2DataMapper mapper;
//
//     @Test
...
//         String sheetName = "煮水百格测试";
//         int startRow = 4;
//         int readColumns = 11; // 指定要读取的列数
//
//         List<DfYfExcelYf115C98bBlueSandblastingGridTestS2Data> dataList = new ArrayList<>();
//         int successCount = 0;
//         int failCount = 0;
//
...
//
//                 try {
//                     DfYfExcelYf115C98bBlueSandblastingGridTestS2Data data = new DfYfExcelYf115C98bBlueSandblastingGridTestS2Data();
//
//                     // 设置实体类字段，按顺序一对一对应
...
//             // 批量保存数据到数据库
//             if (!dataList.isEmpty()) {
//                 for (DfYfExcelYf115C98bBlueSandblastingGridTestS2Data data : dataList) {
//                     try {
//                         mapper.insert(data);
//                         successCount++;
//                     } catch (Exception e) {
...
//      */
//     private boolean isValidData(DfYfExcelYf115C98bBlueSandblastingGridTestS2Data data) {
